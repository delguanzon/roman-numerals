...
describe("RomanNum", () => {
  ...
  test('should return "V" if the value passed is 1', () => {
    let num = new RomanNum(5);
    expect(num.toRoman()).toEqual('V');
  });
  
  test('should return "X" if the value passed is 1', () => {
    let num = new RomanNum(10);
    expect(num.toRoman()).toEqual('X');
  });

  test('should return "L" if the value passed is 1', () => {
    let num = new RomanNum(50);
    expect(num.toRoman()).toEqual('L');
  });

  test('should return "C" if the value passed is 1', () => {
    let num = new RomanNum(100);
    expect(num.toRoman()).toEqual('C');
  });

  test('should return "D" if the value passed is 1', () => {
    let num = new RomanNum(500);
    expect(num.toRoman()).toEqual('D');
  });

  test('should return "M" if the value passed is 1', () => {
